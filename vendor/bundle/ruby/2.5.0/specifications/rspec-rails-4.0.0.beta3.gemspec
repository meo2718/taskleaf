# -*- encoding: utf-8 -*-
# stub: rspec-rails 4.0.0.beta3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2019-10-18"
  s.description = "rspec-rails is a testing framework for Rails 4+.".freeze
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rspec-core>.freeze, ["~> 3.8"])
    s.add_runtime_dependency(%q<rspec-expectations>.freeze, ["~> 3.8"])
    s.add_runtime_dependency(%q<rspec-mocks>.freeze, ["~> 3.8"])
    s.add_runtime_dependency(%q<rspec-support>.freeze, ["~> 3.8"])
    ...
    s.add_dependency(%q<rspec-support>.freeze, ["~> 3.8"])
