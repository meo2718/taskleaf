# -*- encoding: utf-8 -*-
# stub: actionview 5.2.4.5 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v5.2.4.5/actionview/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v5.2.4.5/actionview" } if s.respond_to? :metadata=
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_development_dependency(%q<actionpack>.freeze, ["= 5.2.4.5"])
    s.add_development_dependency(%q<activemodel>.freeze, ["= 5.2.4.5"])
  else
